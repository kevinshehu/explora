...
@Component({
  selector: 'app-home',
  template: `<h2 data-testid="greeting">Welcome to Explora</h2>
    <app-special-greeting />
    <p data-testid="txt-greeting-1">
      Explora is an imaginary travel agency and is used as training application
...
export class HomePage implements OnInit {
  ...
  protected readonly chatService = inject(ChatClient);
